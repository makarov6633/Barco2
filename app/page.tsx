...
export default function Home() {
  ...
  useEffect(() => {
    ...
    let loadedCount = 0;
    const totalAssets = criticalImages.length + 1;
  ...
  return (
    <>
      {isLoading && (
        <div className="fixed inset-0 z-[100] bg-[#0a4d54] flex items-center justify-center">
          <div className="text-center">
            <Image
              ...
              width={100}
              height={100}
              className="rounded-full mx-auto mb-6 animate-pulse"
              priority
            />
